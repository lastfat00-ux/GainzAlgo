...
## 2026-05-21 - Discoverable Shortcuts for Secondary Actions
**Learning:** Keyboard shortcuts for secondary actions (like Copy) improve power-user UX. Pairing them with visual hints (e.g., [C]) and `title` attributes ensures they are discoverable and accessible.
**Action:** Add visual shortcut hints and ARIA-compliant labels to interactive elements with keyboard bindings.
