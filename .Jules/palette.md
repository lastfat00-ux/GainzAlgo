...
## 2024-06-27 - Context-Aware Shortcuts
**Learning:** Overloading global shortcuts (like 'C' for Copy) to be context-aware based on focus (e.g., copying a specific history item when focused) significantly improves efficiency for power users without adding UI clutter.
**Action:** Implement focus-checks in global shortcut listeners to provide contextual actions for interactive data elements.
