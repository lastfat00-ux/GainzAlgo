# Palette Journal
## 2024-06-04 - Momentum & Feedback
**Learning:** Numeric deltas and icon swaps (📋→✅) reduce cognitive load and provide strong visual confirmation for real-time updates and copy actions.
**Action:** Always provide magnitude context and icon transitions.
## 2024-06-05 - Liveness & Continuity
**Learning:** 1s relative timestamps and requestAnimationFrame counters maintain a persistent sense of 'liveness' in high-volatility dashboards.
**Action:** Use high-frequency updates and smooth transitions.
